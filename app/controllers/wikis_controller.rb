...
class WikisController < ApplicationController    
  ...
  uses_tiny_mce(:options => SIMPLE_MCE_OPTIONS) 
  before_filter :render_group_header
#  helper :attachments
#  include AttachmentsHelper   
  ...
  def page  
    ...
    if params[:version] && current_user && !current_user.is_member_of?(@group)
 ...
 #   @version_pages = Wiki.paginate @version_count, per_page_option, params['p']
    # don't load text    
    @versions = @page.content.versions.paginate :all, 
...
private
  ...
  def editable?(page = @page)
    current_user && page.editable_by?(current_user)
  end
